...
(unless *initialized*
  (setf *initialized* t)
  (register-hash-function 'eq     #'sxhash #'eq)
  (register-hash-function 'eql    #'sxhash #'eql)
  (register-hash-function 'equal  #'sxhash #'equal)
  (register-hash-function 'equalp #'sxhash #'equalp)
  (register-builtin #'eq)
